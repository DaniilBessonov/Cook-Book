	...
	<div id="front-page-testimonials" class="front-testimonials testimonials">
		<div class="inner">
			...
			<?php if ( post_type_exists( 'jetpack-testimonial' ) && $testimonials->have_posts() ) : ?>
				...
				<div class="cycle-slideshow" data-cycle-slides="article" data-cycle-auto-height="calc" data-cycle-log="false">
			...
			<?php else : ?>
				...
				<?php if ( current_user_can( 'publish_posts' ) ) : ?>
					...
					<section class="no-results not-found">
						...
						<p>
							<?php printf( esc_html__( 'This section will display your latest testimonials. It can can be disbaled via the Customizer.', 'canape' ) ); ?><br />
